...
package com.eggdevs.cryptocosmos.crypto.presentation.coin_detail
...
import com.eggdevs.cryptocosmos.crypto.presentation.coin_detail.components.CoinInfoCard
import com.eggdevs.cryptocosmos.crypto.presentation.coin_detail.components.LineChart
import com.eggdevs.cryptocosmos.crypto.presentation.coin_list.CoinListState
import com.eggdevs.cryptocosmos.crypto.presentation.coin_list.components.previewCoin
import com.eggdevs.cryptocosmos.crypto.presentation.models.toDisplayableNumber
    ...
    if (state.isLoading) {
        ...
        Column(
            ...
            FlowRow(
                ...
                val priceChangeContentColor = if (isPositiveChange) {
                ...
                CoinInfoCard(
                    ...
                    contentColor = priceChangeContentColor
                )
            }
